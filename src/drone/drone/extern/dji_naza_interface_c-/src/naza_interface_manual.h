...
private:
  int calc_pwm_gradient_right(string stick_motion, int speed_in_perc, int left,
                              int middle, int right);
  int calc_pwm_gradient_left(string stick_motion, int speed_in_perc, int left,
                             int middle, int right);
  int calc_pwm_gradient_throttle(string stick_motion, int speed_in_perc,
                                 int left, int right);
};
